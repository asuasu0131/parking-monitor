...
function renderRods(){
    ...
    rods.forEach(r=>{
        ...
        d.onmousedown=(e)=>{
            ...
            function move(e2){ r.x=e2.clientX-offsetX; r.y=e2.clientY-offsetY; d.style.left=r.x+"px"; d.style.top=r.y+"px"; }
...
document.getElementById("add-rod").onclick = ()=>{
    ...
    rods.push({id:id,x:container.clientWidth/2-50,y:container.clientHeight/2-50,status:0});
    renderRods();
};
